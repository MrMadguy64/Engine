...
All modes are dynamic, i.e. support and parameters of any specific mode is reported by BIOS. For now only color graphic 8bpp, 15bpp, 16bpp, 24bpp and 32bpp RGB/BGR modes are supported.
...
3) ForceBGR: Both standard and non-standard modes. Even rarer case. Not sure, if such video cards exist. Video card supports BGR formats only. Set this option to Enabled in this case.
